...
urlpatterns = [
    ...
    path("distributors/<int:dist_id>/distributor-details/", distributor_details, name="distributor_details"),
    path("add_distributor", netbot.AddDistributorView.as_view(), name="add-dist"),
    path("distributors/<int:d_id>/edit_distributor/", netbot.editDistributor, name="editDistributor"),
    path("distributors/distributor-Retailer-count/", dist_ret_count, name="dist_ret_count"),

    path("subscriptions", SubscriptionsView.as_view(), name="subscriptions-list"),
    path("subscriptions/<int:sub_id>/details/", activeSubscriptions, name="activeSubs"),
    ...
    path("user/<int:user_id>/user-actions/", user_actions, name='user_actions'),
    path("subscription_history", SubscriptionHistoryView.as_view(), name="subscription-history"),
    ...
    path('notifications/<int:not_pk>/details', notification, name='notification_details'),
    ...
    path("cities/change/<int:country_id>", ChangeCityOptions.as_view(), name='change_city_options'),
    # End of Net Bot Access Urls

    # charts urls
    path('api/chart/bar-chart/', Barchart.as_view(), name='Chart'),
    path('api/chart/doughnut-chart/', DoughnutChart.as_view(), name='doughnutChart'),
    ...
    # Orders
    path("_<int:dist_id>/<str:dist_name>/_/orders", OrdersView.as_view(), name="dist-orders"),
    ...
    path('delivery/print/<int:delivery_id>', SalesOrderPrint.as_view(), name="print_order"),
    path('delivery/partial_print/<int:delivery_id>', SalePartialOrderPrint.as_view(), name="partial_print_order"),
    #
    path('history/<str:app_label>/<str:model_name>/<int:object_id>/show', ObjectHistory.as_view(), name="view_history")
