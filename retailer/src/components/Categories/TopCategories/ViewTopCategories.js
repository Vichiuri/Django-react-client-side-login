...
export default function ViewTopCategories({ categories }) {
  ...
  return (
    <div className="section wrapper_sub_category_tabs container_horizontal_tab_postions onlyparent">
      <div className="category-thumb-section">
        <div className="rokan-title  has-see-all">
        ...
        <div className="widget-tabs">
          <div
            className="category_view list-category-item owl-loaded owl-drag"
            data-nav="false"
            data-dots="false"
            data-center="false"
            data-loop="false"
