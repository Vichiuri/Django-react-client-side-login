...
export default function ViewOffersFilter(props) {
  const {
    categories,
    distributor,
  ...
  function changeCategory(category) {
    ...
    if (distributor) {
      fetchViewRetailerOffers(distributor.id, 1, category.id, priceRange);
  ...
  function changeSubCategory(s_category) {
    ...
    if (distributor) {
      fetchViewRetailerOffers(distributor.id, 1, s_category.id, priceRange);
