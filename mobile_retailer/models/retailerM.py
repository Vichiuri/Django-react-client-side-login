...
class MobileOrder(models.Model):
    ...
    product = models.ForeignKey("distributor.Product", on_delete=models.CASCADE, related_name="mobile_order_product")
    ...
    variations = models.ForeignKey("distributor.VariationOptions", on_delete=models.CASCADE, related_name="mobile_order_variation",blank=True,null=True)
...
class MobileDevice(models.Model):
    user = models.ForeignKey("netbotAuth.User", on_delete=models.CASCADE, related_name="devices")
